...
const SPONSORS = [
  ...
  { id: 'meritking',  href: 'https://www.meritsabit.com/',                   klass: 'sp-meritking',   img: '/logos/meritking.png?v=31',          alt: 'MeritKing' },
  { id: 'adidas',     href: 'https://www.adidas.com.tr/',                    klass: 'sp-adidas',      img: '/logos/adidas_ref.png?v=31',         alt: 'adidas' },
  { id: 'heineken',   href: 'https://www.heineken.com/tr/',                  klass: 'sp-heineken',    img: '/logos/heineken_ref.png?v=31',       alt: 'Heineken' },
  { id: 'vodafone',   href: 'https://www.vodafone.com.tr/freezone',          klass: 'sp-vodafone',    img: '/logos/vodafone_fz.png?v=31',        alt: 'Vodafone FreeZone' },
  { id: 'papara',     href: 'https://www.papara.com/',                       klass: 'sp-papara',      img: '/logos/papara.png?v=15',             alt: 'Papara' },
  { id: 'nesine',     href: 'https://www.nesine.com/',                       klass: 'sp-nesine',      img: '/logos/nesine.png?v=15',             alt: 'Nesine' },
  { id: 'mastercard', href: 'https://www.mastercard.com.tr/',                klass: 'sp-mastercard',  img: '/logos/mastercard_transparent.png?v=16', alt: 'Mastercard' },
  { id: 'togg',       href: 'https://www.togg.com.tr/',                      klass: 'sp-togg',        img: '/logos/togg.png?v=15',               alt: 'Togg' },
  { id: 'turkcell',   href: 'https://www.turkcell.com.tr/',                  klass: 'sp-turkcell',    img: '/logos/turkcell.png?v=15',           alt: 'Turkcell' },
  { id: 'sixt',       href: 'https://www.sixt.com.tr/',                      klass: 'sp-sixt',        img: '/logos/sixt.png?v=15',               alt: 'SIXT' },
  { id: 'socar',      href: 'https://www.socar.com.tr/',                     klass: 'sp-socar',       img: '/logos/socar.png?v=31',              alt: 'SOCAR' },
  { id: 'thy',        href: 'https://www.turkishairlines.com/',              klass: 'sp-thy',         img: '/logos/turkishairlines.png?v=15',    alt: 'Türk Hava Yolları' },
  { id: 'garanti',    href: 'https://www.garantibbva.com.tr/',               klass: 'sp-garanti',     img: '/logos/garantibbva.png?v=15',        alt: 'Garanti BBVA' },
  { id: 'avis',       href: 'https://www.avis.com.tr/',                      klass: 'sp-avis',        img: '/logos/avis.png?v=15',               alt: 'AVIS' },
  { id: 'terra',      href: 'https://www.terrapizza.com/',                   klass: 'sp-terra',       img: '/logos/terrapizza.png?v=15',         alt: 'Terra Pizza' },
  { id: 'hdi',        href: 'https://www.hdisigorta.com.tr/',                klass: 'sp-hdi',         img: '/logos/hdisigorta.png?v=15',         alt: 'HDI Sigorta' },
  { id: 'trendyol',   href: 'https://www.trendyol.com/',                     klass: 'sp-trendyol',    img: '/logos/trendyol.png?v=31',           alt: 'Trendyol' },
  { id: 'getir',      href: 'https://getir.com/',                            klass: 'sp-getir',       img: '/logos/getir.png?v=15',              alt: 'Getir' },
  { id: 'hepsiburada',href: 'https://www.hepsiburada.com/',                  klass: 'sp-hepsiburada', img: '/logos/hepsiburada.png?v=15',        alt: 'Hepsiburada' },
  { id: 'digiturk',   href: 'https://www.digiturk.com.tr/',                  klass: 'sp-digiturk',    img: '/logos/digiturk.png?v=15',           alt: 'DigiTürk' },
  { id: 'migros-hemen',href:'https://www.migros.com.tr/hemen',               klass: 'sp-migros',      img: '/logos/migros_hemen.png?v=31',       alt: 'Migros Hemen' },
  { id: 'turknet',    href: 'https://www.turk.net/',                         klass: 'sp-turknet',     img: '/logos/turknet.png?v=1',             alt: 'TurkNet' },
];
  ...
  return (
    <footer className="footer" data-testid="footer">
      ...
      <div className="footer-social">
        <a href="https://www.instagram.com/lenstedreal/" target="_blank" rel="noopener" className="footer-ig" data-testid="ig-link">
