...
async def _fetch_sofascore_as_livescore(http: httpx.AsyncClient, date_str: str) -> Optional[dict]:
    try:
        ...
        for ev in (d.get("events") or []):
            ...
            elif code in (6, 7): eps = "1H" if code == 6 else "2H"
            elif code == 60: eps = "FT"
            else: eps = "NS"
