...
from .routers import scores, streams, bein, channels, auth as auth_router, predictions, chat, notifications, ws, match_stats, admin, push, ai_predict
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        for t in (score_task, st11_task, settle_task):
            t.cancel()
            try:
                await t
